...
//  MasterWords
//
//  Created by Maria Martinez on 9/14/19.
...
public func createPreKList(userName : String) {
    
    //get the user
    user = realm.objects(User.self).filter("name = %@", userName).first!
...
public func createKindergartenList(userName : String) {
...
public func createFirstGradeList(userName : String) {
...
public func createSecondGradeList(userName : String) {
...
public func createThirdGradeList(userName : String) {
